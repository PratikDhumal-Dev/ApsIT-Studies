    ...
    <div className="Title">
      <div className="title">
        <div className="title__text">
          <div className="title__textPrimary">
            <h1>
              Find Everything You need<br></br> At <br></br>
              <strong class="r-link animated-underline animated-underline_type1 news__link">
                &nbsp; Aps&#123;IT&#125; Studies &nbsp;
              </strong>
            </h1>
          </div>
          <div className="title__textSecondary">
            <h2>We offer solutions for every Engineering Problems</h2>
          </div>
        </div>
