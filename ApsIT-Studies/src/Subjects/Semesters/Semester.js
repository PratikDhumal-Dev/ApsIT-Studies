    ...
    <div className="semester">
      <div className="semester_image">
        ...
        >
          ...
          <circle cx="225.47829" cy="71.18959" r="12.5551" fill="#6c63ff" />
      ...
      <div className="semester__text">
        <div className="semester__textPrimary">
          <h1>Semester Wise Distribution</h1>
        </div>
        <div className="semester__textSecondary">
          <h3>Are You Tired of finding stuff for your Semester?</h3>
          <h4>
            Here at ApsIT STudies we provide everything for your Semester at one
            Place
          </h4>
        </div>
        <div className="semester__textButton">
          <div>
