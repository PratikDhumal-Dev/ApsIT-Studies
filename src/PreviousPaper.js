...
function PreviousPaper() {
  return (
    <div className="previousPaper">
      <div className="previousPaper__text">
        <div className="previousPaper__textPrimary">
          <h1>Previous Year Paper Solutions</h1>
        </div>
        <div className="previousPaper__textSecondary">
          <h3>Paper Solutions for every Semester </h3>
        </div>
      ...
      <div className="previousPaper__image">
        <svg
