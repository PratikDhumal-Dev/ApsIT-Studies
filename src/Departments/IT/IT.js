  ...
  return (
    <div>
      ...
      <div className="it">
        ...
        <div className="it__text">
          <div className="it__textPrimary">
            <h1>INFORMATION TECHNOLOGY</h1>
          </div>
          <div className="it__textSecondary">
            <h3>
              Information Technology is a software engineering <br></br>{" "}
              approach to designing and developing information systems.
            </h3>
            <h4>
              Here at ApsIT STudies we provide everything related to IT at one
              place
            </h4>
          </div>
          <div className="it__textButton">
            <div>
