  ...
  return (
    <div>
      <div className="feList">
        <div className="feList__text">
          <h2>FE Department</h2>
        </div>
        <div className="feList__accordion">
          <Accordion defaultActiveKey="">
            <Card className="feList__card">
              <Card.Header>
              ...
              <Accordion.Collapse eventKey="1">
                <Card.Body className="feList__subject">Sem 1</Card.Body>
              </Accordion.Collapse>
              <Accordion.Collapse eventKey="1">
                <Card.Body className="feList__subject">Sem 2</Card.Body>
              </Accordion.Collapse>
            </Card>
            ...
            <Card className="itList__card">
              ...
              <Accordion.Collapse eventKey="5">
                <Card.Body className="itList__subject">Sem 1</Card.Body>
              </Accordion.Collapse>
              <Accordion.Collapse eventKey="5">
                <Card.Body className="itList__subject">Sem 2</Card.Body>
              </Accordion.Collapse>
            </Card>
          </Accordion>
        </div>
        ...
        <div className="semList__accordion">
          <Accordion defaultActiveKey="">
            <Card className="semList__card">
              <Card.Header>
                <Accordion.Toggle as={Button} variant="link" eventKey="0">
                  Engineering Mathematics-II <Icon icon={downCircleFilled} />
                </Accordion.Toggle>
              </Card.Header>
              <Accordion.Collapse eventKey="0">
                <Card.Body className="semList__subject">
            ...
            <Card className="semList__card">
              <Card.Header>
                <Accordion.Toggle as={Button} variant="link" eventKey="1">
                  Engineering Graphics <Icon icon={downCircleFilled} />
                </Accordion.Toggle>
              </Card.Header>
              <Accordion.Collapse eventKey="1">
                <Card.Body className="semList__subject">
            ...
            <Card className="semList__card">
              <Card.Header>
                <Accordion.Toggle as={Button} variant="link" eventKey="2">
                  C programming <Icon icon={downCircleFilled} />
                </Accordion.Toggle>
              </Card.Header>
              <Accordion.Collapse eventKey="2">
                <Card.Body className="semList__subject">
            ...
            <Card className="semList__card">
              <Card.Header>
                <Accordion.Toggle as={Button} variant="link" eventKey="3">
                  Engineering Chemistry-II <Icon icon={downCircleFilled} />
                </Accordion.Toggle>
              </Card.Header>
              <Accordion.Collapse eventKey="3">
                <Card.Body className="semList__subject">Notes</Card.Body>
            ...
            <Card className="semList__card">
              <Card.Header>
                <Accordion.Toggle as={Button} variant="link" eventKey="4">
                  Engineering Physics-II <Icon icon={downCircleFilled} />
                </Accordion.Toggle>
              </Card.Header>
              <Accordion.Collapse eventKey="4">
                <Card.Body className="semList__subject">Notes</Card.Body>
