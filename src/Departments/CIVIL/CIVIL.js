  ...
  return (
    <div>
      ...
      <div className="civil">
        ...
        <div className="civil__text">
          <div className="civil__textPrimary">
            <h1>CIVIL ENGINEERING</h1>
          </div>
          <div className="civil__textSecondary">
            <h3>
              Civil engineering is the professional practice of designing and
              developing infrastructure projects.
            </h3>
            <h4>
              Here at ApsIT STudies we provide everything related to Civil
              Engineering at one place
            </h4>
          </div>
          <div className="civil__textButton">
            <div>
