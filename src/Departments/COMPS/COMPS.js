  ...
  return (
    <div>
      ...
      <div className="comps">
        ...
        <div className="comps__text">
          <div className="comps__textPrimary">
            <h1>COMPUTER SCIENCE ENGINEERING</h1>
          </div>
          <div className="comps__textSecondary">
            <h3>
              Computer engineering is a branch of engineering <br></br> that
              integrates several fields of computer science required to develop
              computer hardware and software.
            </h3>
            <h4>
              Here at ApsIT STudies we provide everything related to COMPS at
              one place
            </h4>
          </div>
          <div className="comps__textButton">
            <div>
